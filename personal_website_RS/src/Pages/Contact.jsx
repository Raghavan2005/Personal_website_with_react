    ...
    <div className="text-center mt-40 p-10">
      ...
      <div className="border w-96 mt-20 rounded-md p-10 mx-auto"> {/* Adjusted padding */}
        ...
        <div className="flex justify-center items-center mb-2"> {/* Adjusted margin */}
          <p className="ml-1 text-xl mr-2">Linkedin -</p>
          <a
            target="_blank"
            href="https://www.linkedin.com/in/raghavan-s-a3b147232/"
            className="text-base text-xl hover:text-blue-300"
          >
            @Raghavan S
          </a>
        </div>
        {/* p2 */}
        <div className="flex justify-center items-center mb-2"> {/* Adjusted margin */}
          <p className="ml-1 text-xl mr-2">X -</p>
          <a
            target="_blank"
        ...
        {/* p3 */}
        <div className="flex justify-center items-center mb-2"> {/* Adjusted margin */}
          <p className="ml-1 text-xl mr-2">Medium -</p>
          <a
            target="_blank"
